#!/usr/bin/env python3
"""
Working AI Meeting Transcriber Demo
Uses requests library to avoid dependency conflicts
"""
...
# Real AI Analysis Service using requests
class RealAIAnalyzer:
    ...
    async def analyze_text(self, text: str, meeting_id: str) -> dict:
        """Analyze text using OpenAI GPT-4 via requests"""
        try:
            if not text.strip():
...
async def health_check():
    ...
    return {
        ...
        "services": {
            ...
            "openai_api": bool(ai_analyzer.api_key)
        },
        "environment": {
